...
public class  LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by a Directional, point light and spotlight
     */
    @Test
    public void sphereMultiLightSources() {
        ...
        scene1.lights.add(
                new DirectionalLight(
                        new Color(400, 0, 0),
                        new Vector(-56, 10, -0.5))
        );
        scene1.lights.add(
                new PointLight(
                        new Color(500, 600, 400),
                        new Point(-60, -60, 25))
                        .setkL(0.001)
                        .setkQ(0.0002));
        scene1.lights.add(
    ...
    /**
     * Produce a picture of two triangles lighted by Directional, point light and spotlight
     */
    @Test
    public void trianglesMultiLightSources() {
        ...
        scene2.lights.add(
                new DirectionalLight(
                        new Color(200, 100, 240), new Vector(-2, -2, -2))
        );
        scene2.lights.add(
